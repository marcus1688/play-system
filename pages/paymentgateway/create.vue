              ...
              >
                ...
                <div class="mt-4 max-md:mt-3">
                  ...
                  <div class="flex flex-col gap-4 max-md:gap-2">
                    <img
                      v-if="bank.imagePreview"
                      :src="bank.imagePreview"
...
const handleSubmit = async () => {
  try {
    ...
    if (formData.value.banks.length > 0) {
    ...
    if (formData.value.availableBankCodes.length > 0) {
    ...
    const { data } = await publicPost("payment-gateways", form);
