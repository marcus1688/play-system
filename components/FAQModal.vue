        ...
        <div class="p-6 border-b max-md:p-4">
          <div class="flex items-center gap-4 max-md:gap-3">
            ...
            <h2 class="text-xl font-semibold max-md:text-lg">
              {{ initialData?._id ? $t("edit") : $t("create") }} {{ $t("faq") }}
            </h2>
          </div>
        </div>
                ...
                <div>
                  <MultiLangInput
                    ...
                    :language-config="[
                      ...
                      { code: 'zh', name: '中文', field: 'questionCN' },
                      {
                        code: 'ms',
                        name: 'Melayu',
                        field: 'questionMS',
                ...
                <div>
                  <MultiLangInput
                    ...
                    :language-config="[
                      ...
                      { code: 'zh', name: '中文', field: 'answerCN' },
                      {
                        code: 'ms',
                        name: 'Melayu',
                        field: 'answerMS',
...
const handleSubmit = async () => {
  try {
    ...
    const { data } = props.initialData?._id
      ? await put(`helps/${props.initialData._id}`, formData.value)
      : await post("helps", formData.value);
