      ...
      <div class="bg-white rounded-lg w-[500px] p-6 max-w-full max-md:p-4">
        <div class="flex items-center justify-between mb-6 max-md:mb-4">
          <div class="flex items-center gap-4 max-md:gap-3">
            ...
            <h2 class="text-xl font-semibold max-md:text-base">
              {{ $t("update_email_minimum_balance") }}
            </h2>
          </div>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4 max-md:space-y-3">
          ...
          <div class="flex justify-end pt-4 max-md:pt-3">
            <button
              type="submit"
              class="px-4 py-2 bg-indigo-600 text-white rounded-lg lg:hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed max-md:w-full max-md:px-3 max-md:py-1.5 max-md:text-sm"
